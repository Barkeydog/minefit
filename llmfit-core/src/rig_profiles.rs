...
pub fn algorithm_rule(algorithm: &str) -> AlgorithmRule {
    match algorithm.to_ascii_lowercase().as_str() {
        ...
        "nexapow" | "dynexsolve" | "qhash" | "sha3x" | "abelhash" | "karlsenhashv2" => {
            AlgorithmRule {
    ...
    MiningRigProfile {
        ...
        benchmarks: vec![
            benchmark(
                ...
                "synthetic GPU discovery baseline",
            ),
            benchmark(
                "SHA256",
                gh(1.85),
                88.0,
                0.20,
                "cgminer CUDA proxy estimate",
                "software SHA256 theoretical 4060 path",
            ),
            benchmark(
                "Ethash",
                mh(33.22),
            ...
            benchmark(
                ...
                0.95,
                "Rigel",
                "balanced ProgPow-family tuning",
            ),
            benchmark(
                "BeamHashIII",
                hs(23.55),
            ...
            benchmark(
                ...
                0.65,
                "lolMiner",
                "inferred from adjacent NVIDIA benchmarks",
            ),
            benchmark(
                "FishHash",
                mh(22.36),
            ...
            benchmark(
                ...
                1.10,
                "GMiner",
                "inferred from 3060/3070 CTXC ladder",
            ),
        ],
    }
}
    ...
    MiningRigProfile {
        ...
        benchmarks: vec![
            benchmark(
                ...
                0.45,
                "minefit market proxy",
                "synthetic high-end GPU discovery baseline",
            ),
            benchmark(
                "SHA256",
                gh(9.80),
                ...
                0.20,
                "cgminer CUDA proxy estimate",
                "software SHA256 theoretical 4090 path",
            ),
            benchmark(
                "Ethash",
                mh(127.0),
            ...
            benchmark(
                ...
                1.05,
                "Rigel",
                "aggressive ProgPow-family tune",
            ),
            benchmark(
                "FishHash",
                mh(73.06),
                ...
                0.80,
                "lolMiner",
                "IRON dual-mining medium benchmark",
            ),
            benchmark(
                "Cortex",
                7.44,
            ...
            benchmark(
                ...
                0.95,
                "Rigel",
                "inferred from 4090/4060 class scaling",
            ),
            benchmark(
                "Qhash",
                gh(3.20),
                ...
                0.55,
                "Rigel",
                "inferred from Ada class scaling",
            ),
            benchmark(
                "KarlsenHashV2",
                mh(82.58),
    ...
    MiningRigProfile {
        ...
        benchmarks: vec![
            benchmark(
                ...
                0.45,
                "minefit market proxy",
                "synthetic AMD GPU discovery baseline",
            ),
            benchmark(
                "SHA256",
                gh(2.60),
                138.0,
                0.25,
                "OpenCL SHA256 proxy estimate",
                "software SHA256 theoretical RDNA2 path",
            ),
            benchmark(
                "Ethash",
                mh(46.95),
                ...
                0.35,
                "TeamRedMiner",
                "1250 core, 675 mv, mem lock 1050",
            ),
            benchmark(
                "Etchash",
                mh(46.95),
            ...
            benchmark(
                ...
                0.90,
                "BzMiner",
                "inferred from 4060 Ti class scaling",
            ),
            benchmark(
                "Xelishashv3",
                kh(9.82),
    ...
    MiningRigProfile {
        ...
        benchmarks: vec![
            benchmark(
                ...
                0.45,
                "minefit market proxy",
                "synthetic Ryzen 5 discovery baseline",
            ),
            benchmark(
                "SHA256",
                mh(55.0),
                ...
                0.25,
                "cpuminer SHA256 estimate",
                "software SHA256 theoretical Ryzen 5 path",
            ),
            benchmark(
                "RandomX",
                kh(8.24),
                65.0,
                0.35,
                "Hashrate.no verified CPU benchmark",
                "desktop RandomX reference",
            ),
            benchmark(
                "AstroBWTv3",
                kh(15.30),
            ...
            benchmark(
                ...
                0.40,
                "Hashrate.no verified CPU benchmark",
                "balanced VerusHash desktop reference",
            ),
        ],
    }
}
    ...
    MiningRigProfile {
        ...
        benchmarks: vec![
            benchmark(
                ...
                0.45,
                "minefit market proxy",
                "synthetic X3D discovery baseline",
            ),
            benchmark(
                "SHA256",
                mh(148.0),
                ...
                0.25,
                "cpuminer SHA256 estimate",
                "software SHA256 theoretical X3D path",
            ),
            benchmark(
                "RandomX",
                kh(22.50),
            ...
            benchmark(
                ...
                0.45,
                "Hashrate.no verified CPU benchmark",
                "CryptoNightTurtle tuned CPU reference",
            ),
        ],
    }
}
    ...
    MiningRigProfile {
        ...
        benchmarks: vec![
            benchmark(
                ...
                0.45,
                "minefit market proxy",
                "synthetic server CPU discovery baseline",
            ),
            benchmark(
                "SHA256",
                mh(430.0),
                ...
                0.25,
                "cpuminer SHA256 estimate",
                "software SHA256 theoretical server CPU path",
            ),
            benchmark(
                "RandomX",
                kh(65.77),
                ...
                0.35,
                "Hashrate.no verified CPU benchmark",
                "server-class RandomX reference",
            ),
            benchmark(
                "AstroBWTv3",
                kh(176.0),
            ...
            benchmark(
                ...
                0.40,
                "Hashrate.no verified CPU benchmark",
                "server-class VerusHash reference",
            ),
            benchmark(
                "XelisHashv3",
                kh(94.50),
                ...
                0.50,
                "Hashrate.no verified CPU benchmark",
                "server-class Xelis CPU reference",
            ),
        ],
    }
}
    ...
    MiningRigProfile {
        ...
        benchmarks: vec![
            benchmark(
                ...
                0.50,
                "minefit market proxy",
                "synthetic generic GPU discovery baseline",
            ),
            benchmark(
                "SHA256",
                gh(1.20),
    ...
    MiningRigProfile {
        ...
        benchmarks: vec![
            benchmark(
                ...
                0.50,
                "minefit market proxy",
                "synthetic generic CPU discovery baseline",
            ),
            benchmark(
                "SHA256",
                mh(40.0),
